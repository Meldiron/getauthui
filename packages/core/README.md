...
```html
<link rel="stylesheet" href="https://unpkg.com/@getauthui/core@0.1.38/dist/fouc.css" />
<script type="module" src="https://unpkg.com/@getauthui/core@0.1.38"></script>
...
```html
<script src="https://unpkg.com/@getauthui/core@0.1.38/dist/authui.cdn.js"></script>
```
