...
```html
<link rel="stylesheet" href="https://unpkg.com/@getauthui/core@0.1.39/dist/fouc.css" />
<script type="module" src="https://unpkg.com/@getauthui/core@0.1.39"></script>
...
```html
<script src="https://unpkg.com/@getauthui/core@0.1.39/dist/authui.cdn.js"></script>
```
