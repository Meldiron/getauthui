...
```html
<link rel="stylesheet" href="https://unpkg.com/@getauthui/core@0.1.40/dist/fouc.css" />
<script type="module" src="https://unpkg.com/@getauthui/core@0.1.40"></script>
...
```html
<script src="https://unpkg.com/@getauthui/core@0.1.40/dist/authui.cdn.js"></script>
```
