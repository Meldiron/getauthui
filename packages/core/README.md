...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@getauthui/core@0.1.32/dist/fouc.css" />
<script type="module" src="https://unpkg.com/@getauthui/core@0.1.32"></script>
...
```html
<script src="https://unpkg.com/@getauthui/core@0.1.32/dist/authui.cdn.js"></script>
```
