...
| Bundle (CDN, gzipped)                 | ~101 KB ESM / ~87 KB IIFE | Larger app SDK         | Hosted (no local UI bundle) | Smaller UI kit              | Your code                  |

Sizes for Auth UI are the published `@getauthui/core@0.1.32` CDN builds (Lit and the Appwrite Web SDK included).
