...
- **Pin versions in production.** Use `@getauthui/core@0.1.36` (or newer) on the CDN, or install from npm, so a release cannot change your login flow without a deploy.
