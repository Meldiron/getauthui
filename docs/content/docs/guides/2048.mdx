...
![Auth UI Sign in to 2048 modal over the classic game board](/guides/2048/signin.png)

![2048 after sign in with the Account button under the board](/guides/2048/signed-in.png)
...
![Auth UI account screen opened from 2048](/guides/2048/account.png)
