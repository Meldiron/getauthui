...
| Method                                                      | Description                          |
| ----------------------------------------------------------- | ------------------------------------ |
| `sendPasswordRecovery(email)`                               | emails a reset link to `redirectUrl` |
| `completePasswordRecovery(userId, secret, password)`        | sets the new password                |
| `sendEmailVerification()`                                   | emails a verification link           |
...
| `listSessions()`, `listIdentities()`, `deleteIdentity(id)`, `listLogs()`                                                     | lists                                            |
...
| `handleRedirect()`    | finish a flow present in `location.search`; returns `true` if one was handled |
