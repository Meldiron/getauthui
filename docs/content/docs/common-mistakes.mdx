...
| URL                                                                 | Use                                                                 |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `https://unpkg.com/@getauthui/core@0.1.26` (or jsDelivr equivalent) | CDN ESM. Elements only. No `window.AuthUI`.                         |
...
<!-- <script type="module" src="https://unpkg.com/@getauthui/core@0.1.26/dist/authui.js"></script> -->
```
